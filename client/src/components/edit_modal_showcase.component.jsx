...
function EditModal(params) {
	...
	// On ok, send values which contains the values of the currently edited showcase,
	// and either the current image or the new image to the current showcase component
	// which would handle the request to the server
	function onOk() {
		form.validateFields()
			.then((values) => {
