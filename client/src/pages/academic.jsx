							...
							<div className="column">
								<figure>
									<img
										...
										src={require("../images/academic-1.jpg")}
										alt="First slide"
									/>
								</figure>
							</div>
						...
						<div className="columns is-vcentered">
							<div className="column">
								<figure>
									<img
										className="image-academic"
										src={require("../images/academic-2.jpg")}
										alt="First slide"
									/>
								</figure>
							</div>
						...
						<div className="columns is-vcentered">
							...
							<div className="column">
								<figure>
									<img
										className="image-academic"
										src={require("../images/academic-3.jpg")}
										alt="First slide"
									/>
								</figure>
							</div>
						...
						<div className="columns is-vcentered">
							<div className="column">
								<figure>
									<img
										className="image-academic"
										src={require("../images/academic-4.jpg")}
										alt="First slide"
									/>
								</figure>
							</div>
							<div className="column">
								<div className="content">
									...
									<p className="has-text-justified">
										Aliquam malesuada enim ac erat tincidunt
										finibus. Interdum et malesuada fames ac
										ante ipsum primis in faucibus. Nunc
										pulvinar dolor dolor, non rhoncus augue
										vestibulum a. In pulvinar metus sed
										dolor tincidunt posuere. Suspendisse
										ligula ante, molestie id lectus nec,
										auctor aliquam neque. Mauris laoreet
										magna ac accumsan eleifend. Ut turpis
										eros, blandit vel est a, condimentum
										vestibulum tellus.
									</p>
								</div>
							</div>
